/*
 * MMSE_SE_IU.h
 * This routine performs MMSE detection with SE and IU
 *  Created on: Mar 16, 2016
 *      Author: tianpei.chen@mail.mcgill.ca
 */

#ifndef MMSE_SE_IU_H_
#define MMSE_SE_IU_H_
#include "SE.h"
#include "IU.h"
void MMSE_SE_IU (gsl_vector_complex *preceived, gsl_matrix_complex *pH,
...
void MMSE_SE_IU (gsl_vector_complex *preceived, gsl_matrix_complex *pH,
		...
		int Nt = pH->size2;
		int count;
		gsl_matrix_complex *G_pre, *G_preInv, *G_preInvIU, *G, *G_nonofuse;
		...
		*signum = 1;
		...
		SE(G_pre, k, G_preInv, G_nonofuse); //SE approximation
